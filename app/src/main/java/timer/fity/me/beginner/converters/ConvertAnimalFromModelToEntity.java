package timer.fity.me.beginner.converters;
...
import timer.fity.me.beginner.domains.Animal;
...
public class ConvertAnimalFromModelToEntity {
    ...
    public static ArrayList<timer.fity.me.beginner.entities.Animal> converter(int categoryId, Context cntx) {

        List<timer.fity.me.beginner.domains.Animal> animalListDomain = new ArrayList<>();
        ArrayList<timer.fity.me.beginner.entities.Animal> animalListEntity = new ArrayList<>();
        ...
        for (Animal animal : animalListDomain) {
            ...
            timer.fity.me.beginner.entities.Animal animalEntity = new timer.fity.me.beginner.entities.Animal(eName, pName, eVoice, pVoice, null, null, animalVoice);
